...
\cite{api} explains how we built this API using the api-server specification
and a tool to automatically generate its code from this specification.
\textbf{translate} is a utility package providing functions to translate
Kubernetes resources to Batsim messages, and \textit{vice versa}.
