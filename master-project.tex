...
\begin{figure}[H]
	\begin{subfigure}
	\centering
	\includegraphics[width=0.5\textwidth]{imgs/min-delay_spaced_200_delay170_crash_old.png}
\end{subfigure}
	\begin{subfigure}
	\centering
	\includegraphics[width=0.5\textwidth]{imgs/min-delay_spaced_200_delay170_duration_old.png}
\end{subfigure}
	\caption{Minimum delay against crash rate, outdated scheduler.}
	\label{fig:min-delay_old}
\end{figure}

As we can see on figure \ref{fig:min-delay_old}, the crash rate decreases
dramatically as soon as the minimum delay reaches a certain threshold which is 10ms here.
