...
\begin{abstract} 
	...
	much more control over resources than physical servers.
        Eventually, developers realized they could go even
	further by automating container management operations to allow push even
	scalability even further. The Cloud Native Computing Foundation was founded in
	this context, and we witnessed the development of Kubernetes: a piece of software
	capable of container orchestration, also refered earlier as container
	management. We currently observe a convergence of HPC (High
	Performance Computing) and Big Data at least research wise. Kubernetes as an
	already established standard for common applications such as Machine Learning,
        ``cite at least 2 more here : map reduce?, ...''
	leaves space for the discussion about leveraging containers in the HPC community. One of the many
	...
	simulators to fast and accuretly model complex networks and computing infrastructures.
        However, the scientific communicty alck of a open source Kubernetes simulator. While the
	default scheduler works for most of the Cloud Native
	infrastructures HPC researches would rather experiment with different batch processing
	policies on Kubernetes as they do with traditional HPC. Our goal in
	this master thesis is to describe Batkube, which is
	...
	developed by LIG ??? Simgrid is developed by many other people (Adrien Lebre: Bordeaux, Martin Quinson: Rennes, etc...).
