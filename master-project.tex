...
\begin{itemize}
	\item A \textit{burst} workload, consisting in an important amount of
		jobs submitted at time zero.  200 delays with duration 170s,
		and requesting 1 cpu, are submitted at the origin.
...
TODO: describe the platform: 16x1cpu for the first two, TBD for the realistic wl.\\

TODO: explain how the workload is extracted and its caracteristics.\\
...
The entirety of the experiments are done with the default Kubernetes scheduler \textbf{kube-scheduler} release \textbf{v1.19.0.rc-4}.

\section{Testing against an emulated cluster}

\subsubsection{Protocol}

TODO: scripts to create a cluster with k3s, scripts to
...
TODO: mention the limit on the amount of cpu and memory.

\subsubsection{Results}

TODO: Show the results, that will serve as a control for the other experiments.
...
TODO: graph: delay vs simulation time
