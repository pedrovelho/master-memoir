...
and the topology the infrastructure. Some systems are centralized like HPC and
Data Centers, others are meant to be used from a distance like Cloud Computing
infrastructures and others are decentralized like Grid Computingn Volunteer
Computing and Peer to Peer computing. There are as many systems as there are
...
left as described in \cite{legrand2015scheduling}: \textit{in vivo}, \textit{in
...
The next sections build upon \cite{legrand2015scheduling} and
\cite{casanova:hal-01017319} by the team behind the
SimGrid\cite{casanova:hal-01017319} simulator, and are aimed at depicting the
current landscape of experimentation on distributed systems.
...
Related projects list (will definetly not include everything. This is not aimed at being a report on the entire simulation world).
\begin{itemize}
...
distributed system driven by Kubernetes.
...
\section{Batsim concepts and objectives}

TODO General concepts of batsim: Language agnostic, ease of use, aimed at
experimenting on scheduling policies, deterministic (reproducibility is at the
core of batsim), coarse grain simulation.
...
\subsubsection{SimGrid}
 ...
 Does this justify a whole subsection? Isn't a paragraph enough for this? I
 don't need to dig deep into SimGrid inner mechanics as this work is at the
 higher level.
